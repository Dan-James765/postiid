...
import "./FeedSettingsSideBar.css";

function FeedSettingsSideBar() {
  return (
    <>
      <div className="feedsettingssidebar__container border-r-[1px] border-gray-300 h-screen xs:hidden md:block">
...
export default FeedSettingsSideBar;
