    ...
    <>
      <div className="bg-gray-50 border-slate-100 border-[1px] h-auto hover:bg-gray-100 cursor-pointer">
        <div className="flex items-center gap-x-1 py-1">
          ...
          />
          <h1 className="hidden cursor-pointer md:block 2xl:font-normal xl:font-normal lg:font-medium lg:text-xs">
            {username}
          </h1>
        </div>
        <h1 className="flex-col hidden md:block lg:text-xs text-gray-400 font-normal truncate">
          {message}
        </h1>
      </div>
    </>
